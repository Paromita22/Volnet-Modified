...
<body>
  <header class="custom-header">
    <nav class="navbar navbar-expand-lg px-3">
        <a href="/pages/homepage.php"><img src="/assets/images/logo_1.png" alt="VolNet Logo" style="height: 60px;"></a>
  ...
  <section class="hero">
    ...
    <div class="hero-content">
      ...
      <button class="apply-btn" onclick="window.location.href='/auth/login.html'">Apply</button>
    </div>
  </section>
...
<div class="how-to-volunteer-container">
    <h2 id="howtoh2">How to Volunteer</h2>
    <div class="steps-wrapper">
        <div class="step-item">
            <div class="step-circle">1</div>
            <div class="step-content">
                <h3>Step 1: Sign Up & Create Your Profile</h3>
                <p>Register on VolNet to get started. Tell us about your skills, interests, and availability so we can match you with the perfect opportunities.</p>
            </div>
        </div>
        ...
        <div class="step-item">
            ...
            <div class="step-content">
                <h3>Step 2: Explore & Apply for Projects</h3>
                <p>Browse through a variety of impactful projects and events. From environmental clean-ups to community support, find what resonates with you.</p>
            </div>
        </div>
        <div class="step-line"></div>
        ...
        <div class="step-item">
            ...
            <div class="step-content">
                <h3>Step 3: Make a Difference</h3>
                <p>Once your application is accepted, join your fellow volunteers and contribute to a cause you care about. Every action counts!</p>
            </div>
        </div>
        <div class="step-line"></div>
        ...
        <div class="step-item">
            ...
            <div class="step-content">
                <h3>Step 4: Track Your Impact & Earn Badges</h3>
                <p>Monitor your volunteer hours, see the impact you've made, and earn special badges and certifications for your dedication and efforts.</p>
            </div>
        </div>
    </div>
</div>
